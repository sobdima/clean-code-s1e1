...
var incompleteTaskHolder = document.getElementById("incomplete-tasks-wrap"); //ul of #incomplete-tasks-wrap
...
var taskIncomplete = function () {
  ...
  //Append the task list item to the #incomplete-tasks-wrap.
  var listItem = this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
